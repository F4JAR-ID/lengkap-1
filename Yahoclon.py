...
os.system("clear")
    print ("\033[39m[\033[31m+\033[39m] Author    : Fajar Id ")
    print ("\033[39m[\033[31m+\033[39m] Facebook  : Jarr Id ")
    print (" ")

idt = raw_input("\033[39m[\033[31m*\033[39m] Masukkan Email   : ")
passw = raw_input("\033[39m[\033[31m*\033[39m] Masukkan Password: ")
...
if 'access_token' in op:
    ...
    print ("\033[39m[\033[31m+\033[39m] Login Berhasil Sob")
else:
    print ("\033[39m[\033[31m+\033[39m] \033[31mLogin Gagal Cukk!")
    sys.exit()
